...
// Optional
$item1_details = array(
    'id' => urldecode($_POST['id_driver']),
    'price' => urldecode($_POST['price']),
    'quantity' => urldecode($_POST['jml_bangku_dipesan']),
    'name' => urldecode($_POST['nama_driver'])
);
...
$billing_address = array(
    'first_name'    => urldecode($_POST['nama_lengkap']),
    // 'last_name'     => "Rizky",
    'address'       => urldecode($_POST['alamat']),
    // 'city'          => "Sukabumi",
    // 'postal_code'   => "143115",
    'phone'         => urldecode($_POST['no_hp']),
    // 'country_code'  => 'IDN'
);
